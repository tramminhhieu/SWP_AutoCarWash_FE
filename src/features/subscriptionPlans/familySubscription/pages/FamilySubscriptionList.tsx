...
export default function FamilySubscriptionList() {
  ...
  const handleSelectPlan = async (
    ...
    try {
      ...
      /* Thành công → navigate sang trang Chi tiết Family Group */
      navigate(`/family/${currentGroup.familyGroupId}`);
    } catch (err) {
    ...
    <div className="mx-auto max-w-page px-margin-mobile py-20 md:px-margin-desktop">
      ...
      {isAdmin && (
        <div className="mt-8 flex justify-end">
          <button
            type="button"
            onClick={() => navigate("/admin/subscription/family/create")}
